...
void Seed::Book() {
    ...
    // seed map
    Save( hSeed_map = new TH2F("hSeed_map", "Seed map", m_Nrows, -0.5, m_Nrows - 0.5, m_Ncols, - 0.5, m_Ncols - 0.5) );
...
// Calculate the noisy pixels, useful for the next analysis.
void Seed::CalculateNoisyPixels(){
